...
-- --------------------------------------------------------------------
-- 4. TABLE: site_analytics (Real-Time Visitor & Session Analytics)
-- --------------------------------------------------------------------
...
DROP POLICY IF EXISTS "Public Read Analytics" ON public.site_analytics;
DROP POLICY IF EXISTS "Public Update Analytics" ON public.site_analytics;

CREATE POLICY "Public Insert Analytics" ON public.site_analytics FOR INSERT WITH CHECK (true);
CREATE POLICY "Public Read Analytics" ON public.site_analytics FOR SELECT USING (true);
CREATE POLICY "Public Update Analytics" ON public.site_analytics FOR UPDATE USING (true);

-- --------------------------------------------------------------------
-- 5. FUNCTION: increment_project_views
-- --------------------------------------------------------------------
CREATE OR REPLACE FUNCTION public.increment_project_views(p_id BIGINT)
RETURNS VOID AS $$
BEGIN
...
CREATE INDEX IF NOT EXISTS idx_analytics_created ON public.site_analytics(created_at DESC);
